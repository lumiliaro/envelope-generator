...
export default function App() {
    ...
    return (
        <div className="flex h-screen bg-slate-100 font-sans overflow-hidden relative">
            <div className="w-[27rem] bg-slate-50 flex flex-col h-full border-r border-slate-200 z-10 shadow-lg shrink-0">
                <div className="p-6 bg-white border-b border-slate-200 flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        <a
                            href="https://github.com/lumiliaro/envelope-generator"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="p-2 text-slate-400 hover:text-slate-800 hover:bg-slate-200/50 rounded-md transition-colors flex items-center justify-center"
