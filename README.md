...
* Set **Scale** to `Default`, `100%`, or `Actual Size` (do *not* use "Fit to Page").
* Ensure the paper size in the print dialog matches the physical envelope you are inserting into your printer.

## 📸 Screenshots

*(Add a screenshot of your app here by uploading an image to your repository and linking it like this: `![App Screenshot](./screenshot.png)`)*
